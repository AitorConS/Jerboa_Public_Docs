...
- **Create your own ARM64 package** from a Linux ARM64 binary, with no Docker
  ...
  [Linux ARM64 packages](/packages-arm64/).
...
More detail: [Firecracker snapshots on macOS](/macos-snapshots/).
...
[Troubleshooting](/troubleshooting/#macos-errors). To build Jerboa
for macOS from source, see [macOS Apple Silicon](/macos/) and
[Firecracker on macOS](/macos-firecracker/).
