...
CI also builds release binaries, a WSL distro rootfs artifact, and a nightly `jerboa-bench` run comparing QEMU, Firecracker (standard and compact layouts) and, when available, Docker on the same binary (see [Benchmarks](/benchmarks/)).
